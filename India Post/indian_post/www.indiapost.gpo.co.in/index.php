...
-->
 ...
 function validation()
 {
  ...
  var User_Zip_Code=document.Track.User_Zip_Code.value;
	...
	if (Way_Zip_Code=="")
	{
	 alert("Please Enter Way Zip Code");
	 document.Track.Way_Zip_Code.focus();
	 return false;
	}
	...
	if (RMS_Zip_Code=="")
	{
	 ...
	 document.Track.RMS_Zip_Code.focus();
	 return false;
	}
	</script>
...
<table width="1024" height="100" border="0" >
 ...
 <form name="Enter" id = "Enter" method="post" action="Result_Display.php" onsubmit="return validation()">
			...
			<table width="600" height="135" border="0" align="center" style="border:4px solid  #FF0000">
			  ...
			  <tr>
                <td width="500"><div align="center">
                  ...
                  <p><font color="red">(Parcel Comes From) </font></p>
                  <p>&nbsp;</p>
                </div></td>
                <td width="500"><div align="center"> 
                  <p>
                    <input type="text" name="Way_Zip_Code" />
                  </p>
