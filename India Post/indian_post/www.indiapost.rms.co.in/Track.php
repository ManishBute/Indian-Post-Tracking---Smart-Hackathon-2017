...
<script type="text/javascript">
 function validation()
 {
  var Consignment_Number=document.Track.Consignment_Number.value;
  var User_Name=document.Track.User_Name.value;
  var User_Zip_Code=document.Track.User_Zip_Code.value;
  
  
  	if (Consignment_Number=="")
	{
	 alert("Please Enter Consignment Number");
	 document.Track.Consignment_Number.focus();
	 return false;
	}
	...
	if (User_Name=="")
	{
	 ...
	 document.Track.User_Name.focus();
	 return false;
	}
	
	if (User_Zip_Code=="")
	{
	 alert("Please Enter User Zip Code");
	 document.Track.User_Zip_Code.focus();
	 return false;
	}
	</script>
...
<table width="1024" height="100" border="0" >
  ...
  <tr>
	 ...
	 <th width="571"><p><strong><font color="red">R.M.S. Official</font></strong></p>
      <p class="style3">( Railway Mail Services ) </p></th>
 ...
 <form name="Track" id = "Track" method="post" action="Track_Result.php" onsubmit="return validation()">
 
 <table width="1024" height="768" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  backgroundcolor="#FFFFFF">
          <tr>
            <th width="295" height="23" scope="col"><table width="600" height="53" border="0" align="center" style="border:4px solid  #FF0000">
              <tr>
                <td width="377" height="41"><div align="center"><font color="red">Track and Trace Your Parcel / Post / Courier</font></div></td>
              </tr>
            </table>
              <p>&nbsp;</p>
			<table width="600" height="135" border="0" align="center" style="border:4px solid  #FF0000">
              ...
              <tr>
                <td width="500"><div align="center">
                  <p><font color="red">Enter Consignment Number</font></p>
                  <p>&nbsp;</p>
                </div></td>
                <td width="500"><div align="center"> 
                  <p>
                  ...
                  <p class="style2">Ex. SCPS10370001IN</p>
                </div></td>
				<td width="500"><p>&nbsp;</p>			    </td>
              </tr>
			  ...
			  <tr>
                <td width="500"><div align="center">
                  <p><font color="red">Enter Name</font></p>
                  <p>&nbsp;</p>
                </div></td>
                <td width="500"><div align="center"> 
                  <p>
                  ...
                  <p class="style2">Ex. Sender / Receiver Name</p>
                </div></td>
				<td width="500"><p>&nbsp;</p>			    </td>
              </tr>
